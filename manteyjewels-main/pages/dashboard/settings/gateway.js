  ...
  const handleForm = async (e) => {
    ...
    try {
      const data = await JSON.stringify({
        ...
        phonePe: phonePe.current.checked,
      });
                    ...
                    <div className="card-body">
                      ...
                      <div className="form-check form-switch my-3 float-end">
                        <input
                          ...
                          id="inp-119"
                          ref={phonePe}
                          defaultChecked={settings.paymentGateway?.phonePe}
                        />
                        <label className="form-check-label" htmlFor="inp-119">
                          {t("Status")}
                        </label>
                      </div>
                    </div>
