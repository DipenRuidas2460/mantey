...
const EditCategory = () => {
  ...
  useEffect(() => {
    if (data && data.category) {
      ...
      setUpdateBannerImage(data.category.banner);
    }
  }, [data]);
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      if (!updateBannerImage[0]) {
        return toast.warning("Please add banner image");
      }
          ...
          <form id="category_form" onSubmit={submitHandler}>
            ...
            <div className="mb-4 pt-2">
              <FileUpload
                ...
                label={`${t("Replace Banner image")}*`}
                maxFileSizeInBytes={20000000}
                updateFilesCb={setUpdateBannerImage}
