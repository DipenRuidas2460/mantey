...
const Checkout = () => {
  ...
  const submitOrder = async () => {
    try {
      ...
      //     city: preInfo?.city,
      //     state: preInfo?.state,
      //     zipCode: preInfo?.zipCode,
      //     country: preInfo?.country,
      //     billingAddress: {
      //       fullName: response.createdOrder.billingInfo.fullName,
      //       billingEmail: response.createdOrder.billingInfo.billingEmail,
      //       phone: response.createdOrder.billingInfo.phone,
      //       house: response.createdOrder.billingInfo.house,
      //       city: response.createdOrder.billingInfo.city,
      //       state: response.createdOrder.billingInfo.state,
      //       zipCode: response.createdOrder.billingInfo.zipCode,
      //       country: response.createdOrder.billingInfo.country,
      //     },
      //     shippingAddress: {
      //       fullName: response.createdOrder.shippingInfo.fullName,
      //       shippingEmail: response.createdOrder.shippingInfo.shippingEmail,
      //       phone: response.createdOrder.shippingInfo.phone,
      //       house: response.createdOrder.shippingInfo.house,
      //       city: response.createdOrder.shippingInfo.city,
      //       state: response.createdOrder.shippingInfo.state,
      //       zipCode: response.createdOrder.shippingInfo.zipCode,
      //       country: response.createdOrder.shippingInfo.country,
      //     },
      //   };

      //   const newResponse = await postData(
      //     `/api/profile?scope=info&id=${session?.user?.id}`,
      //     userInfo
      //   );
      //   response && newResponse.success && response.success
      //     ? (dispatch(resetCart()),
              ...
              <div className="col-md-6">
                <div className={classes.input}>
                  <input
                    ...
                    ref={email2}
                    required
                    defaultValue={preInfo?.shippingInfo?.shippingEmail}
                  />
                </div>
              </div>
              <div className="col-md-6">
              ...
              <div className="col-md-6">
                <div className={classes.input}>
                  <input
                    ...
                    ref={email1}
                    required
                    defaultValue={preInfo?.billingInfo?.billingEmail}
                  />
                </div>
              </div>
              <div className="col-md-6">
